...
assert.match(profile, /admin-app\.js\?v=admin-source-v14/, 'Profile entrypoint must request the canonical runtime revision');
...
assert.match(dashboard, /admin-control-plane-patch\.js\?v=control-plane-v7-dashboard-feature-fit-auto-release/, 'Dashboard must request the logout-placement patch revision');
