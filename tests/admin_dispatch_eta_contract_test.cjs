...
assert.match(page, /control-plane-v10-order-workflow-admin-release/, 'Orders must load the current cache-busted control-plane patch that retains Dispatch/ETA controls');
